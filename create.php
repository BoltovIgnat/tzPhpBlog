				...
				<div class="col-md-12">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputTitle" placeholder="Введите заголовок">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputText">Text</label>
                            <input type="text" class="form-control" id="exampleInputText" placeholder="Ведите текст">
                        </div>
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                            <label class="form-check-label" for="exampleCheck1">Новость на главной</label>
                        </div>
                        <button type="submit" class="btn btn-primary" id="ibtninsert">Записать</button>
                    </form> 
				</div>
			</div>
		</div>
